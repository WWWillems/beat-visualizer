...
export function SettingsScreen({ onDone }: SettingsScreenProps) {
  ...
  const dirty = useMemo(
    ...
    [appDraft, storedAppSettings, songNameDraft, projectSongName],
  );
      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-8 p-6">
        ...
        <section className="space-y-4 rounded-sm border bg-card p-4">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Song metadata for this project. Used as the default export filename.
            </p>
          </div>
          <Separator />

          <div className="space-y-1.5">
            <Label htmlFor="song-name">Current song name</Label>
            <Input
              id="song-name"
              value={songNameDraft}
